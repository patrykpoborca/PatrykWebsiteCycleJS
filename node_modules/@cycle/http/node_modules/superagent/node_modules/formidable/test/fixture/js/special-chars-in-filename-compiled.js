...
function expect(filename) {
  return [{ type: 'field', name: 'title', value: 'Weird filename' }, { type: 'file', name: 'upload', filename: filename, fixture: properFilename }];
};
...
//# sourceMappingURL=special-chars-in-filename-compiled.js.map