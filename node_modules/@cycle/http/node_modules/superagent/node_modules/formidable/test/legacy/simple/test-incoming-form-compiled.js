...
test(function parse() {
  ...
  (function testWithCallback() {
    ...
    var parseCbOk = function parseCbOk(err, fields, files) {
...
test(function _initMultipart() {
  ...
  (function testRegularField() {
    ...
    gently.expect(form, 'onPart', function (part) {
      ...
      assert.deepEqual(part.headers, { 'content-disposition': 'form-data; name="field1"',
        'foo': 'bar'
      });
  ...
  (function testFileField() {
    ...
    gently.expect(form, 'onPart', function (part) {
      assert.deepEqual(part.headers, { 'content-disposition': 'form-data; name="field2"; filename="C:\\Documents and Settings\\IE\\Must\\Die\\Sun"et.jpg"',
...
//# sourceMappingURL=test-incoming-form-compiled.js.map