...
describe('HTTP Driver in Node.js', function () {
  it('should auto-execute HTTP request when factory gets autoSubscribe = true', function (done) {
  ...
  it('should auto-execute HTTP request by default', function (done) {
    var request$ = Cycle.Rx.Observable.just({
      url: uri + '/pet',
      method: 'POST',
      send: { name: 'Woof', species: 'Dog' }
  ...
  it('should not auto-execute HTTP request when factory gets autoSubscribe = false', function (done) {
    var request$ = Cycle.Rx.Observable.just({
      url: uri + '/pet',
      method: 'POST',
      send: { name: 'Woof', species: 'Dog' }
